export const PoPurchaseOrderQueries = {
  ...
  PoPurchaseOrderLineLocations: 'po-purchase-order-line-locations',
  PoPurchaseOrderHeaders: 'po-purchase-order-headers',
  PoPurchaseOrderLines: 'po-purchase-order-lines',
} as const;
